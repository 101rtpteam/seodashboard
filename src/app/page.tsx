...
export default function Dashboard() {
  ...
  const fetchData = async (targetTab?: 'queries' | 'pages' | 'country') => {
    ...
    try {
      ...
      console.log(`DEBUG: API request URL: ${BACKEND_URL}/api/data?${params.toString()}`);
        
      const response = await fetch(`${BACKEND_URL}/api/data?${params}`);
  ...
  const getDailyInsights = async () => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/api/insights/daily`, {
        method: 'POST',
        headers: {
  ...
  const getQueryInsights = async () => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/api/insights/queries`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
